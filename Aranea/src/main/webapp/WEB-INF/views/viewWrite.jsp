            ...
            <div class="containerheader">
               ...
               <div class="nav">
                  <div class="dav">
                     <div class="rav">
                        <div class="logo">
                           <a class="logoimg" href="gomain.com"> <img alt="아라냐 로고" src="images/ARANEALOG2.png" width="300px"
                                 height="90px">
                           </a>
                        </div>
                        ...
                        <div class="search_input">
                           <div class="search">
                              <input type="text" placeholder="상품명, 지역명, @상점명 입력" class="inputTag"> <a class="searchBtn">
                                 <img alt="검색버튼 아이콘" src="images/searchbtn.jpg" width="20" height="20">
                              </a>
                           </div>
                        </div>
                        ...
                        <div class="twopack">
                            <%  if(user == null){ %>
                           <a class="menu button" href="login.com"> <img alt="판매하기 로고" src="images/seller.png"
                                 width="23" height="26"> 판매하기
                           </a> <a class="menu button" href="login.com"> <img alt="내상점 로고" src="images/mystore.png"
                                 width="23" height="24"> 내 상점 ｜
                           </a> <a class="menu button" href="login.com"> <img alt="스파이더맨 신청 로고" src="images/mystore.png"
                                 width="23" height="24"> 스파이더맨 신청 ｜
                           </a>
               ...
               <div class="board">
                  ...
                  <div class="writecontainer"> <!-- 글씨  -->
                        ...
                        <div class="writetitle">
                           ...
                           <div id="sellinfo">
                              ...
                              <div id="username_info">
                                 ...
                                 <div id="username_info_info">
                                    판매자

                                 </div>


                                 <div id="username_info_name">
                                    ${list.user_name }
                                 </div>
                              ...
                              <div id="category_info">
                                 ...
                                 <div id="category_info_info">
                                    카테고리
                                 </div>
                                 <div id="category_info_category">
                                    ${list.cm_category }
                                 </div>
                              </div>
                              <div id="loc_info">
                                 <div id="loc_info_info">
                                    거래지역
                                 </div>
                                 <div id="loc_info_loc">
                                    ${select.loc_name}
                              ...
                              <div id="status_info">
                                 <div id="status_info_info">

                                    상태
                                 </div>
                                 <div id="status_info_status">
                                    ${list.cm_status}
                                 </div>
                              </div>
                           </div>
                     ...
                     <div id="footerbtn">
                        ...
                        <button id="chatbtn" onclick="location.href='chat.com?cm_seq=${list.cm_seq}'">✉채팅</button>
                       <button id="buybtn" onclick="location.href='buypage.com?cm_seq=${list.cm_seq}'">✔구매신청</button>
                     </div>
                  </div>
               </div>
